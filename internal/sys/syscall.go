...
func call18(f uintptr, mask mask, x1, x2, x3, x4, x5, x6, x7, x8, x9, x10, x11, x12, x13, x14, x15, x16, x17, x18 uintptr) uintptr
...
func Call[n size](f uintptr, mask mask, args ...uintptr) uintptr {
	...
	case 16:
		return call18(f, mask, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], args[11], args[12], args[13], args[14], args[15], 0, 0)
	case 17:
		return call18(f, mask, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], args[11], args[12], args[13], args[14], args[15], args[16], 0)
	case 18:
		return call18(f, mask, args[0], args[1], args[2], args[3], args[4], args[5], args[6], args[7], args[8], args[9], args[10], args[11], args[12], args[13], args[14], args[15], args[16], args[17])
	}
	return BadCall
}
